    ...
    function Marker(params){
        var opts = {type: 'webedia', customs: '', saveCustoms: '', uid: '',
        ...
        self.segs = {};
        self.bid = '0da0914b-8f05-4f78-a8ae-bbb30faba42c';
        self.segsFilter = '1051';
            ...
            if(self.fofirdSegs === null){
                if(EZ.isEmpty(self.segs)){
                    if(self.fofird !== null && mustGetSegs){
                        ...
                        EZ.addScript('http://webedia.ezakus.net/marker/segments/r/'+self.ezSegsVarName+'/f/'+self.fofird, function(){
    ...
    ext(EZ.Marker.prototype, {
        mark: function(){
            var self = this,
                ...
                dest = 'http://webedia.ezakus.net/marker/image';
            try {
                if(self.optedOut == 'OPTEDOUT'){
                    return;
                }
