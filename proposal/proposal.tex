...
% CAS suggest "some automatic filtering" instead of "parental filtering"
...
% CAS suggest "easier to use" instead of "easy to use"
...
% CAS suggest "addressing only if" instead of "addressing if"
...
% CAS suggest adding OpenDNS as a known site w/o technical details.
don't provide the technical details on how they work for comfortable use. It is
% CAS sugest "provide enough technical" instead of "provide the technical"
...
% CAS suggest: software running on the child's computer does not protect
% against access via a guest computer.
...
% CAS suggest: add something about potential obstacles. Here are my offhand
% thoughts, feel free to discuss or elaborate.
% [ ] Purchased server hardware may not be fast enough to block access under
% 	stress conditions.  Mitigation: accept fact that some accesses may
% 	not be blocked.
% [ ] The list of websites the children need to use may change faster than 
%	this semster project can accomodate.  Mitigation: add the "stretch 
%	goal" features allowing parents to edit the list.  These features
%	may need to be added after then end of this semster.
