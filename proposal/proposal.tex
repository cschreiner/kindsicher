...
%
% - Why you chose that topic to work on and/or how the backgrounds of group
%   members contribute to the goal.
%
% - Any plans for how to divide the work that you have in place.
%
...
%   approaches.
%
% - A list of milestones and (optionally) dates for those milestones.
